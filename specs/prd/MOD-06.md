...
| RF-06-11 | Al registrarse las calificaciones, el sistema notifica al estudiante por dos canales: (1) **Vista de evaluaciones**: el estudiante puede ver la calificación completa y las observaciones de cada jurado (identificados como "Jurado 1" y "Jurado 2"). (2) **Bandeja de entrada**: mensaje de notificación indicando que las calificaciones están disponibles, con enlace directo a la vista de evaluaciones. El mensaje en bandeja no repite las observaciones | Sistema |
| RF-06-12 | Al aprobarse el anteproyecto, el sistema transiciona automáticamente el estado a **En desarrollo** | Sistema |
| RF-06-13 | Cuando el anteproyecto es reprobado (unánimemente o por Jurado 3), el sistema retorna el estado a **Idea aprobada**. La idea no se pierde; lo que se rehace es el anteproyecto desde cero. Los integrantes registrados se **conservan** y el límite máximo sigue vigente (máx. 3). Si se desea cambiar un integrante antes de re-radicar, se debe seguir el proceso formal de retiro (MOD-08) | Sistema |
