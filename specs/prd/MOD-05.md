...
| RF-05-03 | El sistema valida que el reporte de similitud adjunto sea el documento correcto (sin validar el porcentaje automáticamente — la verificación es responsabilidad del director) | Sistema |
