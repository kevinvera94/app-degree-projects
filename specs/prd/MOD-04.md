...
| RF-04-08 | Al desactivar un docente que tiene trabajos activos como **Director**: el sistema genera una alerta al Administrador con los trabajos afectados. El Administrador debe asignar un nuevo director en cada trabajo antes de que el proceso pueda avanzar de etapa | Sistema / Administrador |
| RF-04-09 | Al desactivar un docente que tiene evaluaciones pendientes como **Jurado**: las evaluaciones ya registradas se conservan. Si la evaluación estaba en curso (sin calificación), el Administrador debe designar un jurado de reemplazo con el mismo número (1 o 2) para completar la evaluación | Sistema / Administrador |
